              ...
              <div className='promotion_box_margins absolute left-0 right-0 bottom-0 top-36 '>
                <div className="flex-grow flex flex-col justify-center items-center">
                  <div className="text-center text-white">
                    <h1 className="font-bold md:text-2xl lg:text-2xl sm:text-2xl text-2xl  sm:visible invisible">Make Work Easier And Life Better With</h1>
          ...
          <div className=" min-h-svh">
            ...
            <div className="flex justify-center  ml-[5%] mr-[5%]">
              <div className="w-full md:w-1/2 flex justify-center">
                <div className="bg-white bg-opacity-25 p-2 rounded-3xl w-full md:max-w-[400px] pl-[5%] pr-[5%]">
                  ...
                  <form onSubmit={handleSubmitmessage} className="mt-8 mb-5">
                    <input
                      ...
                      className="p-2 rounded-[18px] mt-5 mb-5 w-full bg-[#d9d9d920] text-white"
                      value={formData.name}
            ...
            <footer className="bg-black bg-opacity-25  text-white ">
              <div className="container mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div className="sm:flex sm:items-center sm:justify-between mt-5">
                  <Link href="https://jepsoft.com" className="text-sm sm:text-center">© 2024 Jepsoft. All Rights Reserved.</Link>
                  <div className="flex mt-4 sm:justify-center sm:mt-0 space-x-5">
                    <a href="https://web.facebook.com/profile.php?id=61558793650349" className=" hover:text-gray-900">
                      <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                        <path fillRule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clipRule="evenodd" />
                      </svg>
                      <span className="sr-only">Facebook page</span>
                    </a>
                    <a href="https://www.instagram.com/jepsoft?igsh=MTd1dHplcHcweTJleA==" className=" hover:text-gray-900">
                      <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path fill="currentColor" fillRule="evenodd" d="M3 8a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V8Zm5-3a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H8Zm7.597 2.214a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2h-.01a1 1 0 0 1-1-1ZM12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-5 3a5 5 0 1 1 10 0 5 5 0 0 1-10 0Z" clipRule="evenodd" />
                      </svg>
                      <span className="sr-only">Instagram page</span>
                    </a>
                    <a href="https://wa.link/6rkzec" className=" hover:text-gray-900">
                    ...
                    <a href="https://www.linkedin.com/company/jepsoft/about/" className=" hover:text-gray-900">
                      <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
